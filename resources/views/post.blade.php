...
@section('content')
    <section class="single-post-area">
        ...
        <div class="single-post-title bg-img background-overlay"
             style="background-image: url({{asset('images/bg-img/1.jpg')}})">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12">
                        <div class="single-post-thumb">
                            <img src="{{asset($post->photo->file)}}" alt="" class="mx-auto d-block">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <li class="single_comment_area">
                                ...
                                <div class="comment-wrapper d-md-flex align-items-start">
                                    ...
                                    <div class="comment-content">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed dictum nunc
                                            libero, vitae rutrum nunc porta id. Interdum et malesuada fames ac ante
                                            ipsum primis in faucibus. Nam arcu augue, semper at elementum nec, cursus
                                            nec ante.</p>
                    ...
                    <script>
                        ...
                        */
                        (function() { // DON'T EDIT BELOW THIS LINE
                            ...
                            s.src = 'https://laravelblog-yzh2z9engs.disqus.com/embed.js';
...
--}}
  ...
  {{--  <script id="dsq-count-scr" src="//laravelblog-yzh2z9engs.disqus.com/count.js" async></script>--}}
@stop
